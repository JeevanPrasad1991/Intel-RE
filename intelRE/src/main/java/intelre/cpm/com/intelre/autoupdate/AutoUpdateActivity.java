package intelre.cpm.com.intelre.autoupdate;
...
import intelre.cpm.com.intelre.message.AlertMessage;
            ...
            if (update_flag) {
                if (result.equals(CommonString.KEY_SUCCESS)) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        Uri apkUri = FileProvider.getUriForFile(AutoUpdateActivity.this, "cpm.com.intelre.fileprovider", toInstall);
